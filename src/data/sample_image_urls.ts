export const RESNET50_IMAGE_URLS = [
  ...
  export const SQUEEZENET_IMAGE_URLS = [
    { text: 'adults', value: process.env.PUBLIC_URL + '/images/adults-1.jpg' },
    { text: 'adults', value: process.env.PUBLIC_URL + '/images/adults-2.jpg' },
    { text: 'teenagers', value: process.env.PUBLIC_URL + '/images/teenagers-1.jpg' },
    { text: 'teenagers', value: process.env.PUBLIC_URL + '/images/teenagers-2.jpg' },
    { text: 'toddlers', value: process.env.PUBLIC_URL + '/images/toddlers-1.jpg' },
    { text: 'toddlers', value: process.env.PUBLIC_URL + '/images/toddlers-2.jpg' },
    { text: 'toddlers', value: process.env.PUBLIC_URL + '/images/toddlers-3.jpg' },
    { text: 'toddlers', value: process.env.PUBLIC_URL + '/images/toddlers-4.jpg' },
    { text: 'adults', value: process.env.PUBLIC_URL + '/images/adults-3.jpg' },
    { text: 'adults', value: process.env.PUBLIC_URL + '/images/adults-5.jpg' },
    // { text: 'apple', value: 'https://farm8.staticflickr.com/7377/9359257263_81b080a039_z_d.jpg' },
    // { text: 'flower', value: 'https://farm9.staticflickr.com/8295/8007075227_dc958c1fe6_z_d.jpg' },
    // { text: 'mushroom', value: 'https://farm2.staticflickr.com/1449/24800673529_64272a66ec_z_d.jpg'},
    // { text: 'wine', value: 'https://farm4.staticflickr.com/3827/11349066413_99c32dee4a_z_d.jpg' },
